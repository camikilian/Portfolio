        ...
        <header id="home">
          ...
          <div className="row banner">
            <div className="banner-text">
              <h1 className="responsive-headline">Camille Kilian</h1>
              <h3><span>Computer Engineer</span>, <span>Computer Science</span> and <span>Web Designer/Developer</span> Living in Miami, Florida.<br /> 
              Let's <a className="smoothscroll" href="#about">start navigating </a> and learn more <a className="smoothscroll" href="#about">about me</a>.</h3>
              <hr />
              <ul className="social">
